...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2020 at 04:27 PM
...
INSERT INTO `admin_credentials` (`USERNAME`, `PASSWORD`, `ADDRESS`, `PHARMACY_NAME`, `CONTACT_NUMBER`, `EMAIL`) VALUES
('admin', 'admin123', 'Calicut, Kerala', 'Apollo Pharmacy', '8888899999', 'apollo@gmail.com');
...
(1, 'Crosin', 'CROS12', '12/34', 4, 2626, 26),
(2, 'Gelusil', 'G327', '12/42', 0, 15, 12),
(3, 'Dolo 650', 'DOLO327', '01/23', 5, 30, 24),
...
CREATE TABLE `pharmacy`.`sales` ( `CUSTOMER_ID` INT(11) NOT NULL , `INVOICE_NUMBER` INT(11) NOT NULL , `MEDICINE_NAME` VARCHAR(100) CHARACTER SET utf16 COLLATE utf16_bin NOT NULL , `BATCH_ID` VARCHAR(20) CHARACTER SET utf16 COLLATE utf16_bin NOT NULL , `EXPIRY_DATE` VARCHAR(10) CHARACTER SET utf16 COLLATE utf16_bin NOT NULL , `QUANTITY` INT(11) NOT NULL , `MRP` DOUBLE NOT NULL , `DISCOUNT` INT(11) NOT NULL , `TOTAL` DOUBLE NOT NULL ) ENGINE = InnoDB DEFAULT CHARSET=utf16 COLLATE=utf16_bin;